...
import com.gmb.websocket.service.ChatService;
import com.gmb.websocket.model.Chatting;
...
public class ChatController {
    ...
    public void enterUser(@Payload Chatting chat, SimpMessageHeaderAccessor headerAccessor) {
    ...
    public void webSocketDisconnectListener(SessionDisconnectEvent event) {
        ...
        if (username != null) {
            ...
            Chatting chat = Chatting.builder()
                    .type(Chatting.MessageType.LEAVE)
                    .sender(username)
